...
class NewsletterSubscribersController extends Controller
{
    ...
    public function index(Request $request, $list_id)
    {
        try {
            ...
            Session::flash('error', 'Failed to load subscribers: ' . $e->getMessage());
    ...
    public function create($list_id)
    {
        try {
            ...
            Session::flash('error', 'Failed to load list: ' . $e->getMessage());
            return redirect()->route('lists.index');
        }
    }
    ...
    public function store(Request $request, $list_id)
    {
        ...
        try {
            ...
            Session::flash('error', 'Failed to add subscriber: ' . $e->getMessage());
    ...
    public function edit($list_id, $subscriber_id)
    {
        try {
            ...
            Session::flash('error', 'Failed to load subscriber: ' . $e->getMessage());
            return redirect()->route('lists.subscribers.index', $list_id);
        }
    }
    ...
    public function bulkAdd(Request $request, $list_id)
    {
        try {
            ...
            Session::flash('error', 'Failed to bulk add subscribers: ' . $e->getMessage());
            return redirect()->back()->withInput();
        }
    }
}
